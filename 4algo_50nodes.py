...
# =====================================================
GRID_SIZE = 100
NUM_NODES = 50        # Vehicles per map (Changed from 100 to 50)
...
plt.ylabel(f"Maximum Vehicles Covered (Max {NUM_NODES})", fontsize=12, fontweight='bold')
plt.xlabel("Optimization Algorithms", fontsize=12, fontweight='bold')
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.ylim(0, NUM_NODES + 5)
